...
define Build/mt7988-mozart-gpt
	...
	ptgen -g -o $@.tmp -a 1 -l 1024 \
			...
			-t 0x83	-N securestore	-r	-p 128M@1065M \
			-t 0x83	-N lcm_data	-r	-p 10240M@1193M
	cat $@.tmp >> $@
	rm $@.tmp
endef
...
define Device/arcadyan_mozart
  ...
  DEVICE_PACKAGES := kmod-hwmon-pwmfan kmod-usb3 e2fsprogs f2fsck mkf2fs kmod-mt7996-firmware blkid
